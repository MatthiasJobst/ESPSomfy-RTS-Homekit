...
inline void      nvs_close(nvs_handle_t h)              { nvs_handle_ns.erase(h); }
inline esp_err_t nvs_commit(nvs_handle_t)               { return ESP_OK; }
inline esp_err_t nvs_erase_all(nvs_handle_t h)          { nvs_ns_stores[nvs_handle_ns[h]].entries.clear(); return ESP_OK; }
inline esp_err_t nvs_erase_key(nvs_handle_t h, const char *k) { nvs_ns_stores[nvs_handle_ns[h]].entries.erase(k); return ESP_OK; }
