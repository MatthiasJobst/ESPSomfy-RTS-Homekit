...
inline int gpio_uninstall_isr_service()     { return 0; }
...
inline int gpio_intr_enable(gpio_num_t)  { gpio_intr_enabled = true;  return 0; }
inline int gpio_intr_disable(gpio_num_t) { gpio_intr_enabled = false; return 0; }
