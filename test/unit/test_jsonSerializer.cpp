...
class JsonSerializerTest : public ::testing::Test {
  protected:
    ...
    static void parseInto(JsonDocument &doc, const char *json) { deserializeJson(doc, json); }
};
...
{
    const char *types[] = {"roller", "ldrapery", "rdrapery", "cdrapery",    "garage1",   "garage3",
                           "blind",  "awning",   "shutter",  "drycontact2", "drycontact"};
...
TEST_F(JsonSerializerTest, FromJSON_ShadeType_AllStrings)
{
    const struct {
        ...
        {"roller", shade_types::roller},         {"ldrapery", shade_types::ldrapery},
        {"rdrapery", shade_types::rdrapery},     {"cdrapery", shade_types::cdrapery},
        {"garage1", shade_types::garage1},       {"garage3", shade_types::garage3},
        {"blind", shade_types::blind},           {"awning", shade_types::awning},
        {"shutter", shade_types::shutter},       {"drycontact2", shade_types::drycontact2},
