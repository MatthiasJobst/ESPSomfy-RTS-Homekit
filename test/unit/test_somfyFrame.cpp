...
struct StringCmdCase {
    const char *input;
    somfy_commands expected;
};
...
INSTANTIATE_TEST_SUITE_P(
    ExactMatch, TranslateStringTest,
    ::testing::Values(StringCmdCase{"My", somfy_commands::My}, StringCmdCase{"Up", somfy_commands::Up},
                      StringCmdCase{"MyUp", somfy_commands::MyUp}, StringCmdCase{"Down", somfy_commands::Down},
                      StringCmdCase{"MyDown", somfy_commands::MyDown}, StringCmdCase{"UpDown", somfy_commands::UpDown},
                      StringCmdCase{"MyUpDown", somfy_commands::MyUpDown}, StringCmdCase{"Prog", somfy_commands::Prog},
                      StringCmdCase{"SunFlag", somfy_commands::SunFlag},
                      StringCmdCase{"StepUp", somfy_commands::StepUp},
                      StringCmdCase{"StepDown", somfy_commands::StepDown}, StringCmdCase{"Flag", somfy_commands::Flag},
                      StringCmdCase{"Sensor", somfy_commands::Sensor}, StringCmdCase{"Toggle", somfy_commands::Toggle},
                      StringCmdCase{"Favorite", somfy_commands::Favorite}, StringCmdCase{"Stop", somfy_commands::Stop},
                      StringCmdCase{"UP", somfy_commands::Up} // case-insensitive
                      ));

INSTANTIATE_TEST_SUITE_P(
    Prefix, TranslateStringTest,
    ::testing::Values(StringCmdCase{"fav", somfy_commands::Favorite}, StringCmdCase{"FAV", somfy_commands::Favorite},
                      StringCmdCase{"mud", somfy_commands::MyUpDown}, StringCmdCase{"MUD", somfy_commands::MyUpDown},
                      StringCmdCase{"md", somfy_commands::MyDown}, StringCmdCase{"MD", somfy_commands::MyDown},
                      StringCmdCase{"ud", somfy_commands::UpDown}, StringCmdCase{"UD", somfy_commands::UpDown},
                      StringCmdCase{"mu", somfy_commands::MyUp}, StringCmdCase{"MU", somfy_commands::MyUp},
                      StringCmdCase{"su", somfy_commands::StepUp}, StringCmdCase{"SU", somfy_commands::StepUp},
                      StringCmdCase{"sd", somfy_commands::StepDown}, StringCmdCase{"SD", somfy_commands::StepDown},
                      StringCmdCase{"sen", somfy_commands::Sensor}, StringCmdCase{"SEN", somfy_commands::Sensor},
                      StringCmdCase{"p", somfy_commands::Prog}, StringCmdCase{"P", somfy_commands::Prog},
                      StringCmdCase{"u", somfy_commands::Up}, StringCmdCase{"U", somfy_commands::Up},
                      StringCmdCase{"d", somfy_commands::Down}, StringCmdCase{"D", somfy_commands::Down},
                      StringCmdCase{"m", somfy_commands::My}, StringCmdCase{"M", somfy_commands::My},
                      StringCmdCase{"f", somfy_commands::Flag}, StringCmdCase{"F", somfy_commands::Flag},
                      StringCmdCase{"s", somfy_commands::SunFlag}, StringCmdCase{"S", somfy_commands::SunFlag},
                      StringCmdCase{"t", somfy_commands::Toggle}, StringCmdCase{"T", somfy_commands::Toggle}));
...
INSTANTIATE_TEST_SUITE_P(
    AllCommands, TranslateCmdTest,
    ::testing::Values(
        CmdStringCase{somfy_commands::Up, "Up"}, CmdStringCase{somfy_commands::Down, "Down"},
        CmdStringCase{somfy_commands::My, "My"}, CmdStringCase{somfy_commands::MyUp, "My+Up"},
        CmdStringCase{somfy_commands::UpDown, "Up+Down"}, CmdStringCase{somfy_commands::MyDown, "My+Down"},
        CmdStringCase{somfy_commands::MyUpDown, "My+Up+Down"}, CmdStringCase{somfy_commands::Prog, "Prog"},
        CmdStringCase{somfy_commands::SunFlag, "Sun Flag"}, CmdStringCase{somfy_commands::Flag, "Flag"},
        CmdStringCase{somfy_commands::StepUp, "Step Up"}, CmdStringCase{somfy_commands::StepDown, "Step Down"},
        CmdStringCase{somfy_commands::Sensor, "Sensor"}, CmdStringCase{somfy_commands::Toggle, "Toggle"},
        CmdStringCase{somfy_commands::Favorite, "Favorite"}, CmdStringCase{somfy_commands::Stop, "Stop"}));
...
{
    const somfy_commands cmds[] = {somfy_commands::Up,     somfy_commands::Down,    somfy_commands::MyUp,
...
TEST(SomfyFrameTest, EncoDecode_RTS80_AllCommands)
{
    ...
    const Case cases[] = {
        {somfy_commands::Toggle, 0}, {somfy_commands::Favorite, 0}, {somfy_commands::Stop, 0},
        {somfy_commands::StepUp, 3}, {somfy_commands::StepDown, 5}, {somfy_commands::Up, 0},
        {somfy_commands::Down, 0},   {somfy_commands::My, 0},
    };
    for (auto &c : cases) {
        somfy_frame_t tx;
        tx.cmd = c.cmd;
        ...
        if (c.stepSize) EXPECT_EQ(rx.stepSize, c.stepSize) << "cmd=" << (int)c.cmd;
    }
}
...
TEST(SomfyFrameTest, Encode_RTW_UpThroughFlag_ProtoRTW)
{
    ...
    const somfy_commands cmds[] = {
        somfy_commands::Up,     somfy_commands::MyUp,    somfy_commands::Down,
        somfy_commands::MyDown, somfy_commands::UpDown,  somfy_commands::MyUpDown,
        somfy_commands::Prog,   somfy_commands::SunFlag, somfy_commands::Flag,
    };
    for (auto cmd : cmds) {
