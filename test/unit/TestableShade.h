...
class TestableShade : public SomfyShade {
  public:
    MOCK_METHOD(void, emitState, (const char *evt), (override));

    MOCK_METHOD(void, emitState, (uint8_t num, const char *evt), (override));

    MOCK_METHOD(void, emitCommand, (somfy_commands cmd, const char *source, uint32_t sourceAddress, const char *evt),
                (override));
    ...
    void callRealEmitState(const char *evt = "shadeState") { SomfyShade::emitState(255, evt); }
    ...
    void callRealEmitCommand4(somfy_commands cmd, const char *source, uint32_t sourceAddress,
                              const char *evt = "shadeCommand")
    {
