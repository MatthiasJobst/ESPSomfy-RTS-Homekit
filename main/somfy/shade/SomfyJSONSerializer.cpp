...
int8_t SomfyJSONSerializer::validateJSON(JsonObject &obj)
{
    ...
    if (obj.containsKey("shadeType")) {
        if (obj["shadeType"].is<const char *>()) {
            ...
            if (strcmp(s, "roller") == 0)
                type = shade_types::roller;
            else if (strcmp(s, "ldrapery") == 0)
                type = shade_types::ldrapery;
            else if (strcmp(s, "rdrapery") == 0)
                type = shade_types::rdrapery;
            else if (strcmp(s, "cdrapery") == 0)
                type = shade_types::cdrapery;
            else if (strcmp(s, "garage1") == 0)
                type = shade_types::garage1;
            else if (strcmp(s, "garage3") == 0)
                type = shade_types::garage3;
            else if (strcmp(s, "blind") == 0)
                type = shade_types::blind;
            else if (strcmp(s, "awning") == 0)
                type = shade_types::awning;
            else if (strcmp(s, "shutter") == 0)
                type = shade_types::shutter;
            else if (strcmp(s, "drycontact2") == 0)
                type = shade_types::drycontact2;
            else if (strcmp(s, "drycontact") == 0)
    ...
    if (obj.containsKey("proto")) {
        ...
        if (proto == radio_proto::GP_Relay || proto == radio_proto::GP_Remote) {
            ...
            if (type == shade_types::drycontact || ((type == shade_types::garage1 || type == shade_types::lgate1 ||
                                                     type == shade_types::cgate1 || type == shade_types::rgate1) &&
                                                    proto == radio_proto::GP_Remote))
                upPin = myPin = 255;
            ...
            if (ret == 0) {
                for (uint8_t i = 0; i < SOMFY_MAX_SHADES; i++) {
                    ...
                    if ((upPin != 255 && s->usesPin(upPin)) || (downPin != 255 && s->usesPin(downPin)) ||
...
int8_t SomfyJSONSerializer::fromJSON(JsonObject &obj)
{
    ...
    if (err == 0) {
        ...
        if (obj.containsKey("hasTilt"))
            shade->tiltType = static_cast<bool>(obj["hasTilt"]) ? tilt_types::none : tilt_types::tiltmotor;
...
void SomfyJSONSerializer::toJSON(JsonResponse &json)
{
    ...
    json.addElem("gpioLLTrigger",
                 ((shade->gpioControl.gpioFlags & (uint8_t)gpio_flags_t::LowLevelTrigger) == 0) ? false : true);
