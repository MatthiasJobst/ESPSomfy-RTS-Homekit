...
static const char *TAG = "SomfyGPIOControl";

void SomfyGPIOControl::setGPIOs(radio_proto proto,
                                 float currentPos,
                                 int8_t direction,
...
void SomfyGPIOControl::triggerGPIOs(somfy_frame_t &frame,
                                     radio_proto proto,
                                     shade_types shadeType,
                                     bool isToggle) {
...
bool SomfyGPIOControl::usesPin(uint8_t pin,
                                radio_proto proto,
                                shade_types shadeType,
                                bool isToggle) const {
