...
enum class group_types : byte { channel = 0x00 };
...
enum class tilt_types : byte { none = 0x00, tiltmotor = 0x01, integrated = 0x02, tiltonly = 0x03, euromode = 0x04 };
...
typedef enum : byte { waiting_synchro = 0, receiving_data = 1, complete = 2 } t_status;
...
enum class gpio_flags_t : byte { LowLevelTrigger = 0x01 };
