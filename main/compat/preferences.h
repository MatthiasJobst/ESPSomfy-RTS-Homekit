...
class Preferences {
  ...
  public:
    ...
    bool putString(const char *key, const String &val) { return putString(key, val.c_str()); }
    ...
    bool clear() { return nvs_erase_all(_handle) == ESP_OK && nvs_commit(_handle) == ESP_OK; }
    size_t freeEntries()
    {
        nvs_stats_t stats = {};
    ...
    PreferenceType getType(const char *key)
    {
        ...
        switch (type) {
        case NVS_TYPE_I8:
            return PreferenceType::PT_I8;
        case NVS_TYPE_U8:
            return PreferenceType::PT_U8;
        case NVS_TYPE_U16:
            return PreferenceType::PT_U16;
        case NVS_TYPE_I16:
            return PreferenceType::PT_I16;
        case NVS_TYPE_I32:
            return PreferenceType::PT_I32;
        case NVS_TYPE_U32:
            return PreferenceType::PT_U32;
        case NVS_TYPE_I64:
            return PreferenceType::PT_I64;
        case NVS_TYPE_U64:
            return PreferenceType::PT_U64;
        case NVS_TYPE_STR:
            return PreferenceType::PT_STR;
        case NVS_TYPE_BLOB:
            return PreferenceType::PT_BLOB;
        default:
            return PreferenceType::PT_INVALID;
        }
    }
};
